namespace ReplayLoader.Languages
{
    public class Simplified_Chinese : LocalizedText
    {
        public Simplified_Chinese()
        {
            ...
            registerSpecifiedKeyText = "按下已注册按键时保存回放文件";
            progressTitle = "进程";
            ...
            agreed = "同意";
            noAgreed = "拒绝";
            saveWhen90P = "当你在关卡进度大于等于 90% 死亡时自动保存回放文件";
            ...
            notSupportOfficialLevel = "官方关卡并不受到支持";
            ...
            removeOnlyMyReplay = "只能删除属于你的回放文件";
            preparing = "正在准备中……";
            autoUpdate = "自动更新";
            nextTimeUpdate = "下次再更新";
            newReplayVersion = "新的回放模组版本！";
